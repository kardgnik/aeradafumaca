# Nó de Distribuição 7B

#Lugares
#Spoiler

O Nó de Distribuição 7B é uma instalação da rede de Éter localizada em um distrito antigo de [[Brumaferro]]. Oficialmente, sua função é regular o fornecimento de energia entre setores industriais e linhas secundárias.
...
Os sistemas desse nível contêm Éter mesmo quando o restante do nó é isolado. A energia percorre trajetos que não aparecem nos mapas e é desviada para uma estrutura ainda mais profunda.

## Relação com a estação desativada
